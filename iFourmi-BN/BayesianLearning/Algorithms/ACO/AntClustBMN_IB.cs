...
{
    public class AntClustBMN_IB:ACOClustering_IB,IClassificationAlgorithm
    {
        #region Data Member
        ...
        {
            return "AntClustBMN_IB:" + "k=" + this._clustersNumber.ToString() + "-" + _dataset.Metadata.DatasetName;
        }
