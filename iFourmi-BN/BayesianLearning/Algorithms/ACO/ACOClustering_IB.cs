...
{
    public class ACOClustering_IB: AntColony<ClusterExampleAssignment>,IClusteringAlgorithm
    {
        #region Data Members
        ...
        public ACOClustering_IB(int maxIterations, int colonySize, int convergenceIterations, Problem<ClusterExampleAssignment> problem, int clustersNumber, DataMining.ProximityMeasures.ISimilarityMeasure similarityMeasure, Dataset dataset, bool performLocalSearch)
        ...
        public ACOClustering_IB(int maxIterations, int colonySize, int convergenceIterations, Problem<ClusterExampleAssignment> problem, int clustersNumber, DataMining.ProximityMeasures.ISimilarityMeasure similarityMeasure, bool performLocalSearch)
            : base(maxIterations, colonySize, convergenceIterations, problem)
        {
            this._clustersNumber = clustersNumber;
            this._similarityMeasure = similarityMeasure;
        ...
        public override void Initialize()
        {
            ...
            this._graph = ConstructionGraphBuilder.BuildIBClusteringConstructionGraph(this.Dataset, this._clustersNumber);
            ...
            ((ClusteringIBInvalidator)this.Problem.ComponentInvalidator).ClustersNumber = this._clustersNumber;
        ...
        public override void CreateSolution()
        {
            ...
            for (int antIndex = 0; antIndex < this.ColonySize; antIndex++)
            {
                ...
                for (int i = 0; i < this._clustersNumber; i++)
                    this.ConstructionGraph.Components[i].IsValid = true;

                Ant<ClusterExampleAssignment> ant = new Ant<ClusterExampleAssignment>(antIndex, this);
