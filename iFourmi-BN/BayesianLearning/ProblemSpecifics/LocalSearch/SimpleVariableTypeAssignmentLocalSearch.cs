...
{
    public class SimpleVariableTypeAssignmentLocalSearch : ILocalSearch<VariableTypeAssignment>
    {
        #region Data Members
        ...
        public SimpleVariableTypeAssignmentLocalSearch(ISolutionQualityEvaluator<VariableTypeAssignment> qualityEvaluator)
        {
        ...
        public void PerformLocalSearch(Ant<VariableTypeAssignment> ant)
        {
            ...
            for (int index =0; index < solution.Components.Count; index++)
            {
                ...
                for (int i = firstOptionIndex+2; i < firstOptionIndex + 3; i++)
                {
