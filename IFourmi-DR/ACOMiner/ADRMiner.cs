...
{
    public class ADRMiner:AntColony<DRComponent>, IWekaClassificationAlgorithm
    {
        ...
        public ADRMiner(int maxIterations, int colonySize, int convergenceIterations, Problem<DRComponent> problem, bool useAttributes, bool useInstances, bool performLocalSearch, Dataset trainingSet)
        ...
        public ADRMiner(int maxIterations, int colonySize, int convergenceIterations, Problem<DRComponent> problem, bool useAttributes, bool useInstances, bool performLocalSearch)
        ...
        {
            ((HeuristicCalculators.ADRHeuristicCalculator)this.Problem.HeuristicsCalculator).InitilizeHeuristicInformation(this._trainingSet,_useAttributes,_useInstances);
        ...
        private bool IsValid(Solution<DRComponent> solution)
        {
            bool IsValid = false;
        ...
        public override string ToString()
        {
            ...
            return "ADRMiner+I -" + _trainingSet.Metadata.DatasetName;
        }
