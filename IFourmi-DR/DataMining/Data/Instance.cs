...
namespace iFourmi.DataMining.Data
{
    public class Instance: ICloneable
    {
        ...
        public Instance(Metadata Metadata, int index, double[] values, int label)
        {
        ...
        public Instance(Metadata Metadata, int index, double[] values, List<int> label)
        {
            this._metadata = Metadata;
            this._index = index;
            this._values = values;            
        ...
        public object Clone()
        {
            ...
            return new Instance(this._metadata, this._index, (double[])this._values.Clone(), cloneLabel);
        }
    }
}
